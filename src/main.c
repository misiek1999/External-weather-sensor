 ...
 */
#if defined(CONFIG_UART_CONSOLE) && CONFIG_UART_CONSOLE
...
static void broadcast_weather_data(uint8_t flags, int32_t temp_centi, int32_t hum_centi,
                                   uint16_t battery_mv, uint16_t sequence)
{
    int err;
